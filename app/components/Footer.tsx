...
const Footer: React.FC = () => {
    return (
        <footer className='text-[15px] container   max-w-xl m-auto  '>
            <div>
            <div className='flex xs:flex-col md:flex-row sm:items-center items-center md:justify-center uppercase  text-primary   xs:gap-3 md:gap-6  md:mb-[20px] xs:mb-[30px] pt-[71px] xs:mx-[20px]'>
