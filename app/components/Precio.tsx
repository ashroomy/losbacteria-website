...
const Precio: React.FC<PrecioProps> = ({ precio }) => {
	return (
		<div className={`price-bg border-black border-4  min-w-[130px] text-black h-[100px] w-fit text-center relative bg-[#FF4E00] rounded-[50%] md:py-[4px] md:px-[10px] xs:py-[0] xs:px-[0] rotate-[12.303deg] z-[-1]`}>
